...
// has 49 lines, 294 words, and 2026 bytes, which you can verify by running cargo run src/main.rs
//
...
// not a text file, e.g. cargo run wc /bin/bash or cargo run wc c:\windows\system32\cmd.exe
//
// Your tasks:

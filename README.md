...
A Rust university course for CS faculty students. Assumes intermediate C/C++ knowledge.
...
1. Ability to teach Rust to other people
1. Get practical, hands-on experience
1. Deep dive, intermediate level Rust skill
1. Know the problems Rust aims to solve
1. Ability to judge whether Rust fits project requirements
1. Know why Rust features are the way they are
